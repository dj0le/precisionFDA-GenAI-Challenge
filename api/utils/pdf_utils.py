...
def process_pdf(file_path: str, file_id: str, file_hash: str, original_filename: str = None) -> List[Dict]:
    ...
    for page in pdf_data:
        ...
        if not source and original_filename:
            source = original_filename.rsplit('.', 1)[0]
        if not source:
